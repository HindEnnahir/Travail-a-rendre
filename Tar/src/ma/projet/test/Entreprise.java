...
public class Entreprise {
    ...
    public static void main(String[] args) {
        ...
        Developpeur dev1 = new Developpeur("Dev 1", 9000);
        Developpeur dev2 = new Developpeur("Dev 2", 9500);
        developpeurService.create(dev1);
        developpeurService.create(dev2);
        Manager manager = new Manager("Manager 1", 8000);
        managerService.create(manager);
        Developpeur dev3 = new Developpeur("Dev 3", 6000);
